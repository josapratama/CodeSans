  ...
  return (
    <>
     {dataCardDepartmentsTwo?.map((values) => (
        <div key={values.id} className='flex flex-col px-5 py-6 gap-y-[30px]'>
            <div className='flex gap-4'>
                <img src={values.icon} alt={values.title} className='bg-secondary w-[90px] h-[90px] rounded-xl py-4 px-5' />
