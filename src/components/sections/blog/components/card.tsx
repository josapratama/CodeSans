...
export const Card = ({ imgSrc, date, title }: CardProps) => {
  return (
    <div data-aos="zoom-in-up" className="w-full h-auto max-w-full rounded-[20px] shadow-shadowCard bg-white overflow-hidden">
      <img
        src={imgSrc}
        alt={title}
      ...
      <div className="p-5">
        ...
        <p className="text-base font-medium cursor-pointer text-primary hover:underline">
          Learn More
        </p>
      </div>
    </div>
