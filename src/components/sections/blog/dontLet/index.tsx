...
export const DontLetYourHealth = () => {
  return (
    <section className="translate-y-[100px] sm:translate-y-[188px]">
      <div className="container relative h-[550px] sm:h-[650px] md:h-[700px] max-w-full lg:mx-4 bg-white shadow-[6px_4px_70px_8px_rgba(48,123,196,0.09)] mt-8 sm:mt-16 md:mt-30 pt-8 sm:pt-12 md:pt-36 px-4 sm:px-8 lg:pl-36 rounded-[30px] ">
