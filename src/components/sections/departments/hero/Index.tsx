...
const HeroBanner = () => {
  return (
    ...
    >
      ...
      />
      <div className="container px-4 py-20 overflow-hidden max-w-7xl lg:px-0">
        <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-start gap-[70px]">
          <div className="flex flex-col gap-6 -translate-y-10 w-full lg:w-[50%]">
            <SectionTitle dataAos="fade-right" classname="leading-tight">
              Get to Know <br />
              ProHealth Departments
            </SectionTitle>
            <p data-aos="fade-right" className="text-lg font-Poppins text-primary">
