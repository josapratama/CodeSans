      ...
      <div className="container px-4 overflow-hidden max-w-7xl lg:px-0">
        <div className="flex flex-col lg:flex-row items-center justify-center lg:justify-start gap-[70px]">
          ...
          <div className="flex flex-col gap-6 -translate-y-10 w-full lg:w-[50%]">
            <h2 data-aos="fade-left"  data-aos-once="true" className=" md:text-4xl text-3xl lg:text-[53px] font-bold text-primary lg:leading-tight tracking-widest">
              Wellcome to <br />
              ProHealth Galler
            </h2>
            <p data-aos="fade-left"  data-aos-once="true" className="text-lg font-Poppins text-primary">
